package cn.edu.bupt.ch2_1.config;
...
public class SwaggerConfiguration {
    ...
    public Docket createDemoApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("cn.edu.bupt.ch2_1")) // 设置对哪些包内的api进行监控
                .paths(PathSelectors.ant("/api/demo/**")) // 仅监控路径/api/demo/**
